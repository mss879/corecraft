...
export default function AdminLoginPageClient() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#020305] text-white">
      ...
      />
      <div
        className="absolute inset-0 bg-[linear-gradient(135deg,rgba(255,255,255,0.08),transparent)] mix-blend-screen"
        aria-hidden="true"
      />
        ...
        <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          >
            ...
            <p className="text-center text-xs text-white/50">
              Having trouble?{' '}
              <a href="mailto:hello@corecraft.agency" className="text-white">
                Contact support.
              </a>
            </p>
          </form>
